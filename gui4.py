...
R1.pack()
R2=tkinter.Radiobutton(top,command=selection,text="option 2",variable=var,value=1,
                       selectcolor="green",activebackground="blue",activeforeground="pink",
                       bg="pink",cursor="arrow")
R2.pack()
R3=tkinter.Radiobutton(top,command=selection,text="option 3",variable=var,value=1,
                       selectcolor="green",activebackground="blue",activeforeground="pink",
                       bg="pink",cursor="arrow")
R3.pack()
top.mainloop()
